...
const App = () => {
    ...
    return (
        <div className="mx-2 my-2 w-fit sm:mx-auto sm:my-6 sm:w-3/4 lg:w-3/5">
            <div>
                {/* Grid / Table */}
                <div className="mb-4 grid grid-cols-11 rounded-md border-2 border-gray-300 bg-gray-300 text-sm shadow-md">
                    {/* Grid labels */}
                    ...
                    <div className="col-span-2 border-b-2 border-l border-gray-300 bg-gray-100 p-1 text-center">Add kg / side</div>
                    <div className="col-span-4 border-b-2 border-l border-gray-300 bg-gray-100 p-1 text-center">Plates to add / side</div>
                    <div className="col-span-2 border-b-2 border-l border-gray-300 bg-gray-100 p-1 text-center">Closest</div>
                    ...
                    <div className="col-span-4 col-start-6 grid w-full grid-cols-7 border-l bg-gray-300 text-xs">
